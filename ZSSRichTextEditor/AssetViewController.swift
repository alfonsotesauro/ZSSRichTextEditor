...
class AssetViewController: UIViewController {
    ...
    @IBOutlet weak var tapOnPhotoRecognizer: UITapGestureRecognizer!
    ...
    @objc func userDidTapInPicture(_ sender: UITapGestureRecognizer) {
        ...
        self.dismiss(animated: true) {
            guard let image = (sender.view as! UIImageView).image else { fatalError() }
            print("Eccoci \(image)")
        }
    }
    ...
    override func viewDidLoad() {
        ...
        tapRecognizer.addTarget(self, action: #selector(userDidTapInPicture))
